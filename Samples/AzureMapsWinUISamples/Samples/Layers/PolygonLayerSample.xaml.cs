...
{
    public sealed partial class PolygonLayerSample : Page
    {
        /*********************************************************************************************************
        ...
        *********************************************************************************************************/
        ...
        private async Task CreateFillPatterns()
        {
            ...
            using (var s = new FileInfo(Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "Assets/map_resources/images/rough_grass_texture.jpg")).OpenRead())
            {
