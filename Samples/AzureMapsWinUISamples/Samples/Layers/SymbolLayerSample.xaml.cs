...
{
    public sealed partial class SymbolLayerSample : Page
    {
        /*********************************************************************************************************
        ...
        *********************************************************************************************************/
        ...
        private async Task CreateIcons()
        {
            ...
            using (var s = new FileInfo(Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "Assets/map_resources/images/pin.png")).OpenRead())
            {
