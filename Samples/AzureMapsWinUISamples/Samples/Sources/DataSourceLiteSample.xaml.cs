...
{
    public sealed partial class DataSourceLiteSample : Page
    {
        /*********************************************************************************************************
        ...
        *********************************************************************************************************/
        ...
        private async void ImportFromStream_Clicked(object sender, RoutedEventArgs e)
        {
            ...
            using (var stream = new FileInfo(Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "Assets/map_resources/data/geojson/SamplePoiDataSet.json")).OpenRead())
            {
