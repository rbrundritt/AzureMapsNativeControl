...
public partial class PopupsSample : ContentPage
{
    /*********************************************************************************************************
    ...
    *********************************************************************************************************/
    ...
    private async void PopupScenarioPicker_SelectedIndexChanged(object sender, EventArgs e)
    {
        ...
        var scenario = Helpers.GetSelectedPickerString(sender);
