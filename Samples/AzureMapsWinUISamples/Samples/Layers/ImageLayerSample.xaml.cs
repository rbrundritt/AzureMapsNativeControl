...
{
    public sealed partial class ImageLayerSample : Page
    {
        /*********************************************************************************************************
        ...
        *********************************************************************************************************/
        ...
        private async Task PreloadImageOptions()
        {
            ...
            *****************************************************************/
            ...
            using (var imageStream = new FileInfo(Path.Combine(AppDomain.CurrentDomain.BaseDirectory, "Assets/map_resources/images/image-overlays/Chicago_1872_Map.jpg")).OpenRead())
            {
