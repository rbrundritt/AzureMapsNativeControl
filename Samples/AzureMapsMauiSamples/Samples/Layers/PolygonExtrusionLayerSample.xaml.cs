...
public partial class PolygonExtrusionLayerSample : ContentPage
{
    /*********************************************************************************************************
    ...
    *********************************************************************************************************/
    ...
    /// <param name="sender"></param>
    /// <param name="e"></param>
    private void FillPicker_SelectedIndexChanged(object sender, EventArgs e)
    {
    ...
    /// <param name="sender"></param>
    /// <param name="e"></param>
    private void HeightScaleSlider_ValueChanged(object sender, ValueChangedEventArgs e)
    {
    ...
    /// <param name="sender"></param>
    /// <param name="e"></param>
    private void BaseSlider_ValueChanged(object sender, ValueChangedEventArgs e)
    {
        var slider = (Slider)sender;
