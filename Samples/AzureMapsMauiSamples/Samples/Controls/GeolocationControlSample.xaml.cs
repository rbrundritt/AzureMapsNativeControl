...
public partial class GeolocationControlSample : ContentPage
{
    /*********************************************************************************************************
    ...
    *********************************************************************************************************/
    ...
    private void MarkerColorPicker_SelectedIndexChanged(object sender, EventArgs e)
    {
        if (MyGeolocationControl != null)
        {
    ...
    private void ShowUserLocationCheckBox_CheckedChanged(object sender, CheckedChangedEventArgs e)
    {
    ...
    private void TrackUserLocationCheckBox_CheckedChanged(object sender, CheckedChangedEventArgs e)
    {
        if (MyGeolocationControl != null && sender is CheckBox cbx)
        {
    ...
    private void CalculateMissingValuesCheckBox_CheckedChanged(object sender, CheckedChangedEventArgs e)
    {
        if (MyGeolocationControl != null && sender is CheckBox cbx)
        {
    ...
    private void UpdateMapCameraCheckBox_CheckedChanged(object sender, CheckedChangedEventArgs e)
    {
        if (MyGeolocationControl != null && sender is CheckBox cbx)
        {
    ...
    private void EnableCompassCheckBox_CheckedChanged(object sender, CheckedChangedEventArgs e)
    {
        if (MyGeolocationControl != null && sender is CheckBox cbx)
        {
    ...
    private void SyncMapCompassHeadingCheckBox_CheckedChanged(object sender, CheckedChangedEventArgs e)
    {
        if (MyGeolocationControl != null && sender is CheckBox cbx)
        {
