...
{
    public sealed partial class SnakelineAnimationSample : Page
    {
        /*********************************************************************************************************
        ...
        *********************************************************************************************************/
        ...
        private async void PlayAnimation()
        {
            if (animation == null)
            {
                ...
                animation = await MapAnimations.Snakeline(pathFeature, dataSource, animationOptions, AnimateMapCbx.IsChecked == true);
            }
