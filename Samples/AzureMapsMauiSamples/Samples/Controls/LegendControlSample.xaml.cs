...
public partial class LegendControlSample : ContentPage
{
    /*********************************************************************************************************
    ...
    *********************************************************************************************************/
    ...
    private void TitleEntry_Changed(object sender, TextChangedEventArgs e)
    {
        if(legendControl != null)
        {
            ...
            legendControl.Title = e.NewTextValue;
        }
    }
    ...
    private void MaxWidthSlider_ValueChanged(object sender, ValueChangedEventArgs e)
    {
        if (legendControl != null)
        {
            int maxWidth = (int)e.NewValue;
    ...
    private void ShowToggleCheckBox_CheckedChanged(object sender, CheckedChangedEventArgs e)
    {
        if (legendControl != null)
        {
            ...
            legendControl.ShowToggle = e.Value;
        }
    }
    ...
    private void MiminizedCheckBox_CheckedChanged(object sender, CheckedChangedEventArgs e)
    {
        if (legendControl != null)
        {
            ...
            legendControl.Miminized = e.Value;
        }
    }
