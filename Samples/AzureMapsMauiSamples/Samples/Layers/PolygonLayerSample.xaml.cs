...
public partial class PolygonLayerSample : ContentPage
{
    /*********************************************************************************************************
    ...
    *********************************************************************************************************/
    ...
    /// <param name="sender"></param>
    /// <param name="e"></param>
    private void FillColorPicker_SelectedIndexChanged(object sender, EventArgs e)
    {
    ...
    /// <param name="sender"></param>
    /// <param name="e"></param>
    private void FillPatternPicker_SelectedIndexChanged(object sender, EventArgs e)
    {
    ...
    /// <param name="sender"></param>
    /// <param name="e"></param>
    private void FillOpacitySlider_ValueChanged(object sender, ValueChangedEventArgs e)
    {
    ...
    /// <param name="sender"></param>
    /// <param name="e"></param>
    private void OutlinePolygonCheckBox_CheckedChanged(object sender, CheckedChangedEventArgs e)
    {
    ...
    /// <param name="sender"></param>
    /// <param name="e"></param>
    private void ShowPolygonPointsCheckBox_CheckedChanged(object sender, CheckedChangedEventArgs e)
    {
        var checkBox = (CheckBox)sender;
    ...
    private async Task CreateFillPatterns()
    {
        ...
        using (var s = await FileSystem.Current.OpenAppPackageFileAsync("map_resources/images/rough_grass_texture.jpg"))
        {
