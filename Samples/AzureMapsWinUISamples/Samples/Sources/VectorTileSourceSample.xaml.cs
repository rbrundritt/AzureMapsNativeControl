...
{
    public sealed partial class VectorTileSourceSample : Page
    {
        /*********************************************************************************************************
        ...
        *********************************************************************************************************/
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void DisplayAsPicker_SelectedIndexChanged(object sender, SelectionChangedEventArgs e)
        {
            if (incidentClusterLayer == null)
            {
                return;
            }
