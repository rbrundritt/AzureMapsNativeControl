...
{
    public sealed partial class BubbleLayerSample : Page
    {
        /*********************************************************************************************************
        ...
        * This sample is based on these Azure Maps Web SDK samples: 
        ...
        private void ColorPicker_SelectedIndexChanged(object sender, SelectionChangedEventArgs e)
        {
        ...
        private void UpdateRadius(object sender, RoutedEventArgs e)
        {
            ...
            if (DataDrivenRadiusCheckBox.IsChecked != null && DataDrivenRadiusCheckBox.IsChecked.Value)
            {
        ...
        private void PitchAlignmentPicker_SelectedIndexChanged(object sender, SelectionChangedEventArgs e)
        {
            if (bubbleLayer == null)
            {
                return;
