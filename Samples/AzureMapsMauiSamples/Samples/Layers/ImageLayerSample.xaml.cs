...
public partial class ImageLayerSample : ContentPage
{
    /*********************************************************************************************************
    ...
    *********************************************************************************************************/
    ...
    private async Task PreloadImageOptions()
    {
        ...
        *****************************************************************/
        ...
        using (var imageStream = await FileSystem.Current.OpenAppPackageFileAsync("map_resources/images/image-overlays/Chicago_1872_Map.jpg"))
        {
    ...
    /// <param name="sender"></param>
    /// <param name="e"></param>
    private async void ImageSourcePicker_SelectedIndexChanged(object sender, EventArgs e)
    {
    ...
    /// <param name="sender"></param>
    /// <param name="e"></param>
    private void HueRotationSlider_ValueChanged(object sender, ValueChangedEventArgs e)
    {
        var slider = (Slider)sender;
    ...
    /// <param name="sender"></param>
    /// <param name="e"></param>
    private void ContrastSlider_ValueChanged(object sender, ValueChangedEventArgs e)
    {
        var slider = (Slider)sender;
