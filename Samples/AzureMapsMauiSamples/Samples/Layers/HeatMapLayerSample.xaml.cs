...
public partial class HeatMapLayerSample : ContentPage
{
    /*********************************************************************************************************
    ...
    *********************************************************************************************************/
    ...
    private void HeatGradientPicker_SelectedIndexChanged(object sender, EventArgs e)
    {
    ...
    private void ZoomScaledRadiusCheckBox_CheckedChanged(object sender, CheckedChangedEventArgs e)
    {
    ...
    private void WeightedCheckBox_CheckedChanged(object sender, CheckedChangedEventArgs e)
    {
        var checkBox = (CheckBox)sender;
