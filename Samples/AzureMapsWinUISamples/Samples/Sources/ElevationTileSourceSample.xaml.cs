...
{
    public sealed partial class ElevationTileSourceSample : Page
    {
        /// <summary>
        ...
        private void ExaggerationSlider_ValueChanged(object sender, RoutedEventArgs e)
        {
            if (MyMap == null)
            {
                return;
        ...
        private void DisableElevationCheckBox_CheckedChanged(object sender, RoutedEventArgs e)
        {
            if (MyMap == null)
            {
                return;
