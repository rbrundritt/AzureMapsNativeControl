...
public partial class LineLayerSample : ContentPage
{
    /*********************************************************************************************************
    ...
    *********************************************************************************************************/
    ...
    /// <param name="sender"></param>
    /// <param name="e"></param>
    private void StrokeColorPicker_SelectedIndexChanged(object sender, EventArgs e)
    {
    ...
    /// <param name="sender"></param>
    /// <param name="e"></param>
    private void ShowIconsOnLinesCheckBox_CheckedChanged(object sender, CheckedChangedEventArgs e)
    {
    ...
    /// <param name="sender"></param>
    /// <param name="e"></param>
    private void DashLinesCheckBox_CheckedChanged(object sender, CheckedChangedEventArgs e)
    {
        var checkBox = (CheckBox)sender;
    ...
    /// <param name="sender"></param>
    /// <param name="e"></param>
    private void ShowLinePointsCheckBox_CheckedChanged(object sender, CheckedChangedEventArgs e)
    {
        var checkBox = (CheckBox)sender;
