...
{
    public sealed partial class ExtrudedGriddedDataSourceSample : Page
    {
        /*********************************************************************************************************
        ...
        *********************************************************************************************************/
        ...
        /// <param name="sender"></param>
        /// <param name="e"></param>
        private void GridTypePicker_SelectedIndexChanged(object sender, SelectionChangedEventArgs e)
        {
            if (dataSource != null)
            {
                popup.Close();
