...
public partial class LayerControlSample : ContentPage
{
    /*********************************************************************************************************
    ...
    *********************************************************************************************************/
    ...
    private void TitleEntry_Changed(object sender, TextChangedEventArgs e)
    {
        if (layerControl != null)
        {
            ...
            layerControl.Title = e.NewTextValue;
        }
    }
    ...
    private void ShowToggleCheckBox_CheckedChanged(object sender, CheckedChangedEventArgs e)
    {
        if (layerControl != null)
        {
            ...
            layerControl.ShowToggle = e.Value;
        }
    }
    ...
    private void MiminizedCheckBox_CheckedChanged(object sender, CheckedChangedEventArgs e)
    {
        if (layerControl != null)
        {
            ...
            layerControl.Miminized = e.Value;
        }
    }
