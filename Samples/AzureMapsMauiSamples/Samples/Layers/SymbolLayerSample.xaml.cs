...
public partial class SymbolLayerSample : ContentPage
{
    /*********************************************************************************************************
    ...
    *********************************************************************************************************/
    ...
    /// <param name="sender"></param>
    /// <param name="e"></param>
    private void IconOpacitySlider_ValueChanged(object sender, ValueChangedEventArgs e)
    {
    ...
    /// <param name="sender"></param>
    /// <param name="e"></param>
    private void IconSizeSlider_ValueChanged(object sender, ValueChangedEventArgs e)
    {
        var slider = (Slider)sender;
    ...
    /// <param name="sender"></param>
    /// <param name="e"></param>
    private void IconRotationSlider_ValueChanged(object sender, ValueChangedEventArgs e)
    {
        var slider = (Slider)sender;
        ...
        IconRotationLabel.Text = $"{rotation}";
    }
    ...
    /// <param name="sender"></param>
    /// <param name="e"></param>
    private void ShowTextCheckBox_CheckedChanged(object sender, CheckedChangedEventArgs e)
    {
    ...
    /// <param name="sender"></param>
    /// <param name="e"></param>
    private void TextColorPicker_SelectedIndexChanged(object sender, EventArgs e)
    {
    ...
    /// <param name="sender"></param>
    /// <param name="e"></param>
    private void TextSizeSlider_ValueChanged(object sender, ValueChangedEventArgs e)
    {
        var slider = (Slider)sender;
    ...
    private async Task CreateIcons()
    {
        ...
        using (var s = await FileSystem.Current.OpenAppPackageFileAsync("map_resources/images/pin.png"))
        {
