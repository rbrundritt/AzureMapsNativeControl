...
public partial class AnimateMultiplePointsSample : ContentPage
{
    /*********************************************************************************************************
    ...
    *********************************************************************************************************/
    ...
    private void PlayTogether(object sender, EventArgs e)
    {
        animation?.Dispose();
        PlayAnimation(GroupAnimationPlayType.Together);
    }

    private void PlaySequentially(object sender, EventArgs e)
    {
        animation?.Dispose();
    ...
    private void PlayInterval(object sender, EventArgs e)
    {
        animation?.Dispose();
