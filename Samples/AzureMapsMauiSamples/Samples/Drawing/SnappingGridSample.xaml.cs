...
public partial class SnappingGridSample : ContentPage
{
    /*********************************************************************************************************
    ...
    private void EnabledCheckBox_CheckedChanged(object sender, CheckedChangedEventArgs e)
    {
        ...
        snapGrid.Enabled = e.Value;
    }

    private void RemoveDuplicatesCheckBox_CheckedChanged(object sender, CheckedChangedEventArgs e)
    {
        //Specifies duplicate sequential positions should be removed when snapping.
        snapGrid.RemoveDuplicates = e.Value;
    }

    private void ResolutionSlider_ValueChanged(object sender, ValueChangedEventArgs e)
    {
        ...
        var resolution = (int)Math.Round(e.NewValue);
    ...
    private void ShowGridCheckBox_CheckedChanged(object sender, CheckedChangedEventArgs e)
    {
        ...
        snapGrid.ShowGrid = e.Value;
    }

    private void SimplifyCheckBox_CheckedChanged(object sender, CheckedChangedEventArgs e)
    {
        //Specifies if a Douglas-Peucker simplification should occur while snapping to create smoother lines.
        snapGrid.Simplify = e.Value;
    }

    private void GridColorPicker_SelectedIndexChanged(object sender, EventArgs e)
    {
